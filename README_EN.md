...
- All scripts support cross-platform(Only tested on Win10 and Mac systems).
...
TypeScript's public runtime library tslib will be installed as dependencies.  
If the operating environment of your library is nodeJS, you can add tslib to the external of rollup.config to reduce the package size; if the operating environment of your library is browser, you don’t need to change it, and tslib will be packaged together (introduced on demand).
